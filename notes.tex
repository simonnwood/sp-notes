...
\end{enumerate}
The following is R code for one way of doing this. It could be typed, line by line into the R console, but it is better to type it into a file and then copy and paste to the R console, or {\tt source} the file into R, or run it in Rstudio. 
\begin{verbatim}
